...
const i18n = {
  ar: {
    ...
    'nav.privacy': 'الخصوصية والسياسة',
    'nav.contact': 'اتصل بنا',

    'home.heroTitle': 'كتالوج B2B أنيق لعرض منتجات ETL',
    'home.heroText': 'استعرض مجموعاتك بسرعة وأناقة، مع دعم التحميل كملف PDF ولغتين.',
    'home.ctaBrowse': 'تصفح الأقسام',
    'home.ctaDownload': 'تحميل الكتالوج',
    'home.chipFast': 'خفيف وسريع',
    'home.chipB2B': 'تصميم B2B',
    'home.chipBi': 'ثنائي اللغة',
    'home.chipPdf': 'تحميل PDF',

    // ==== About (AR) ====
    'about.title': 'عن ETL',
    'about.h1': 'من نحن',
    'about.lead': 'ETL شركة متخصصة في حلول الكتالوج الصناعي B2B، نقدم واجهات أنيقة وتجربة استخدام ممتازة.',
    'about.vision': 'رؤيتنا',
    'about.visionText': 'أن نكون المنصة المفضلة لكتالوجات الشركات في المنطقة.',
    'about.mission': 'رسالتنا',
    'about.missionText': 'تمكين الشركات من عرض منتجاتها باحترافية لزيادة الثقة والمبيعات.',

    // Contact
    'contact.title':'اتصل بنا', 'contact.h1':'راسلنا', 'contact.name':'الاسم', 'contact.msg':'رسالتك', 'contact.send':'إرسال',
    'contact.direct':'تواصل مباشر', 'contact.openMap':'افتح في خرائط جوجل',
    'contact.phName': 'محمد أحمد', 'contact.phEmail':'name@example.com', 'contact.phMessage':'...',

    // Catalogue
    'catalogue.title':'كتالوج ETL', 'catalogue.h1':'كتالوج ETL', 'catalogue.lead':'حمل الكتالوج حسب السنة أو استعرض الأقسام.',
    'catalogue.cat1':'معدات التعبئة', 'catalogue.cat1Text':'معدات عالية الكفاءة لمختلف الاستخدامات.',
    'catalogue.cat2':'خطوط الإنتاج', 'catalogue.cat2Text':'حلول متكاملة بتكلفة مناسبة.',
    'catalogue.cat3':'مواد خام', 'catalogue.cat3Text':'توريد موثوق طويل الأمد.',
    'catalogue.cat4':'ملحقات', 'catalogue.cat4Text':'قطع غيار وصيانة.',
    'catalogue.view':'عرض المنتجات →',

    // Privacy
    'privacy.title':'الخصوصية والسياسة', 'privacy.h1':'سياسة الخصوصية',
    'privacy.p1':'نحترم خصوصيتك ونلتزم بحماية بياناتك. تشرح هذه السياسة كيفية جمع واستخدام المعلومات.',
    'privacy.h2':'المعلومات التي نجمعها', 'privacy.li1':'بيانات التواصل الأساسية.', 'privacy.li2':'استفسارات الكتالوج والطلبات.',
    'privacy.h3':'حقوقك', 'privacy.p2':'يمكنك طلب الوصول أو التصحيح أو الحذف لبياناتك في أي وقت عبر البريد الإلكتروني.',

    // Footer
    'footer.tag': 'حلول كتالوج احترافية للشركات.', 'footer.quick': 'روابط', 'footer.contact': 'تواصل',
    'footer.whatsapp': 'واتساب', 'footer.email': 'إيميل',
  },
  en: {
    ...
    // ==== Home (EN) ====
    'site.title': 'ETL — Business Catalogue',
    'nav.home': 'Home',
    'nav.about': 'About Us',
    ...
    'home.heroTitle': 'A Sleek B2B Catalogue to Showcase ETL Products',
    'home.heroText': 'Browse your collections quickly and elegantly, with PDF download and bilingual support.',
    'home.ctaBrowse': 'Browse Sections',
    'home.ctaDownload': 'Download Catalogue',
    'home.chipFast': 'Lightweight & Fast',
    'home.chipB2B': 'B2B Design',
    'home.chipBi': 'Bilingual',
    'home.chipPdf': 'PDF Export',

    // ==== About (EN) ====
    'about.title': 'About ETL',
    'about.h1': 'About Us',
    'about.lead': 'ETL specializes in B2B industrial catalogue solutions, delivering elegant UIs and great UX.',
    'about.vision': 'Our Vision',
    'about.visionText': 'To be the preferred corporate catalogue platform in the region.',
    'about.mission': 'Our Mission',
    'about.missionText': 'Empower companies to present products professionally to boost trust and sales.',

    // Contact
    'contact.title':'Contact Us', 'contact.h1':'Contact Us', 'contact.name':'Name', 'contact.msg':'Your Message', 'contact.send':'Send',
    'contact.direct':'Direct Contact', 'contact.openMap':'Open in Google Maps',
    'contact.phName': 'Mohamed Ahmed', 'contact.phEmail':'name@example.com', 'contact.phMessage':'...',

    // Catalogue
    'catalogue.title':'ETL Catalogue', 'catalogue.h1':'ETL Catalogue', 'catalogue.lead':'Download yearly catalogues or browse sections.',
    'catalogue.cat1':'Packaging Equipment', 'catalogue.cat1Text':'High-efficiency equipment for varied use cases.',
    'catalogue.cat2':'Production Lines', 'catalogue.cat2Text':'Integrated, cost-effective solutions.',
    'catalogue.cat3':'Raw Materials', 'catalogue.cat3Text':'Reliable long-term supply.',
    'catalogue.cat4':'Accessories', 'catalogue.cat4Text':'Spare parts & maintenance.',
    'catalogue.view':'View products →',

    // Privacy
    'privacy.title':'Privacy & Policy', 'privacy.h1':'Privacy Policy',
    'privacy.p1':'We respect your privacy and are committed to protecting your data. This policy explains how information is collected and used.',
    'privacy.h2':'Information we collect', 'privacy.li1':'Basic contact details.', 'privacy.li2':'Catalogue inquiries and requests.',
    'privacy.h3':'Your rights', 'privacy.p2':'You may request access, correction, or deletion of your data at any time via email.',

    // Footer
    'footer.tag': 'Professional catalogue solutions for businesses.', 'footer.quick': 'Quick Links', 'footer.contact': 'Contact',
...
function injectFooter(){
  document.querySelectorAll('footer.site-footer').forEach(foot=>{
    if(foot.innerHTML.includes('{{FOOTER}}')){
      const base = document.querySelector('.site-footer');
      if (base) foot.innerHTML = base.innerHTML;
    }
  });
}

const PDF_BASE = './'; // نفس مجلد الصفحة
...
function applyTranslations(lang){
  ...
  document.querySelectorAll('[data-i18n]').forEach(el=>{
    ...
    if (el.tagName.toLowerCase() === 'title') {
      if (map[key]) document.title = map[key];
    } else if (map[key]) {
  ...
  document.querySelectorAll('[data-i18n-placeholder]').forEach(el=>{
    ...
    if (key && map[key] && 'placeholder' in el) {
...
function toggleLang(){
  ...
  localStorage.setItem('etl_lang', next);

  const btn = document.getElementById('langBtn');
  if (btn) btn.textContent = (next === 'ar') ? 'EN' : 'AR';

  applyTranslations(next);

  // استدعاءات آمنة على حسب وجود العناصر/الدوال
  if (typeof renderCatalogueYears === 'function') renderCatalogueYears();
...
// ==================== Contact (اختياري) ====================
// لن يتم استدعاؤها تلقائياً لتجنب التعارض مع سكريبت fetch في الصفحة.
// لو عايز تستخدمها في صفحة تجريبية، حط data-demo="1" على <form id="contactForm">
function handleContactForm(){
  const form = document.getElementById('contactForm');
  if(!form) return;
  if (form.dataset.demo !== '1') return; // حماية من التعارض
  form.addEventListener('submit', (e)=>{
    e.preventDefault();
    alert(document.documentElement.lang==='ar'
      ? 'تم إرسال رسالتك بنجاح (نموذج تجريبي).'
      : 'Your message has been sent (demo form).'
    );
    form.reset();
  });
}

// ==================== Local data + filters + products ====================
...
function boot(){
  ...
  // صفحات/عناصر اختيارية
  if (typeof renderCatalogueYears === 'function') renderCatalogueYears();
  if (typeof populateFilters === 'function')      populateFilters();
  if (typeof wireFilters === 'function')          wireFilters();
  if (typeof renderProducts === 'function')       renderProducts();

  // لا تستدعِ المعالج التجريبي إلا لو محدد بوضوح على الفورم
  if (document.getElementById('contactForm')?.dataset.demo === '1') {
